...
ti.targets.arm.elf.M3.rootDir ?= C:/ti7/ccsv7/tools/compiler/ti-cgt-arm_16.9.4.LTS
...
.dlls,em3 .dlls: MAX30100.pem3

-include package/cfg/MAX30100_pem3.mak
-include package/cfg/MAX30100_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/MAX30100_pem3.dep
endif
MAX30100.pem3: package/cfg/MAX30100_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
MAX30100.pem3 package/cfg/MAX30100_pem3.c: .libraries,em3
endif

package/cfg/MAX30100_pem3.c package/cfg/MAX30100_pem3.h package/cfg/MAX30100_pem3.xdl: override _PROG_NAME := MAX30100.xem3
package/cfg/MAX30100_pem3.c: package/cfg/MAX30100_pem3.cfg
package/cfg/MAX30100_pem3.xdc.inc: package/cfg/MAX30100_pem3.xdl
package/cfg/MAX30100_pem3.xdl package/cfg/MAX30100_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/MAX30100_pem3.cfg
	-$(RM) package/cfg/MAX30100_pem3.dep
	-$(RM) package/cfg/MAX30100_pem3.c
	-$(RM) package/cfg/MAX30100_pem3.xdc.inc

clean,em3::
	-$(RM) MAX30100.pem3
.executables,em3 .executables: MAX30100.xem3

MAX30100.xem3: |MAX30100.pem3

-include package/cfg/MAX30100.xem3.mak
MAX30100.xem3: package/cfg/MAX30100_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/MAX30100_pem3.oem3   package/cfg/MAX30100_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
MAX30100.xem3: export C_DIR=
MAX30100.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
MAX30100.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

MAX30100.test test,em3 test: MAX30100.xem3.test

MAX30100.xem3.test:: MAX30100.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 MAX30100.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.MAX30100.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,MAX30100.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
MAX30100_pem3.oem3,copy : package/cfg/MAX30100_pem3.oem3
MAX30100_pem3.sem3,copy : package/cfg/MAX30100_pem3.sem3
